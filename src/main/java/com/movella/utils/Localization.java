...
public class Localization {
  public final static String notFound = "Não encontrado.";
  public final static String unauthorized = "Não autorizado.";
  public final static String forbidden = "Acesso não permitido.";
